	...
	methods: {
		...
		reload: function (event) {
			...
			$("#jqGrid").jqGrid('setGridParam',{ 
				postData:{'key': vm.q.key,'timestart':vm.warn.stime,'timeend':vm.warn.etime},
                page:page
            }).trigger("reloadGrid");
		},
        export_excel:function (event) {
		    vm.warn.stime = vm.warn.stime ==null?"":vm.warn.stime;
            vm.warn.etime = vm.warn.etime ==null?"":vm.warn.etime;
            vm.q.key = vm.q.key ==null?"":vm.q.key;
            var url = baseURL+"api/exportlog?timestart="+ vm.warn.stime+"&timeend="+vm.warn.etime+"&key="+vm.q.key;
